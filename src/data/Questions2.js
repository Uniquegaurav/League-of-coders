...
export const QuestionsEasy = Questions2.filter((que) => {
     return (que.difficulty ==='Easy')&&(que.premium === false)
});

export const QuestionsMedium = Questions2.filter((que) => {
    return (que.difficulty ==='Medium')&&(que.premium === false)
});
export const QuestionsHard = Questions2.filter((que) => {
    return (que.difficulty ==='Hard')&&(que.premium === false)
});
